...
class TripServiceTest {
    ...
    void getTripReturnsAccommodationAndTripEndArrivalSummaries() {
        ...
        assertThat(response.dayEndRoutes().get(0).destinationLatitude()).isEqualTo(33.4);
        assertThat(response.dayEndRoutes().get(0).destinationLongitude()).isEqualTo(126.5);
        ...
        assertThat(response.dayEndRoutes().get(1).destinationLatitude()).isEqualTo(33.0);
        assertThat(response.dayEndRoutes().get(1).destinationLongitude()).isEqualTo(126.0);
    ...
    void getTripReturnsTripStartAndAccommodationDepartureSummaries() {
        ...
        assertThat(response.dayStartRoutes().get(0).originLatitude()).isEqualTo(33.0);
        assertThat(response.dayStartRoutes().get(0).originLongitude()).isEqualTo(126.0);
        ...
        assertThat(response.dayStartRoutes().get(1).originLatitude()).isEqualTo(33.4);
        assertThat(response.dayStartRoutes().get(1).originLongitude()).isEqualTo(126.5);
